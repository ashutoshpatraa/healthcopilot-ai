...
SYMPTOM_MAP: list[tuple[str, str]] = [
    ...
    ("stomach bloating", "distention_of_abdomen passage_of_gases abdominal_pain"),
    ("bloated tummy", "distention_of_abdomen abdominal_pain stomach_pain passage_of_gases"),
    ("bloated stomach", "distention_of_abdomen abdominal_pain stomach_pain passage_of_gases"),
    ("bloated", "distention_of_abdomen passage_of_gases abdominal_pain"),
    ...
    ("pale poop", "yellowing_of_skin dark_urine"),
    ("pale stool", "yellowing_of_skin dark_urine"),
    ...
    ("frequent trips to bathroom", "polyuria"),
    ("dark urine", "dark_urine"),

    # Cognitive / Neuro
    ("memory loss", "loss_of_balance altered_sensorium"),
